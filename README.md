...
```bash
git clone git@bitbucket.org:rc1/dotfiles.git && cd dotfiles && source bootstrap.sh
```
...
```bash
cd; curl -#L https://github.com/<username>/dotfiles/tarball/master | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh}
```
...
[Mathias Bynens](https://github.com/mathiasbynens/dotfiles) the parent of these dotfiles.
